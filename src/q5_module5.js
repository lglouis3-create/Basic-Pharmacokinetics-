...
{id:'m5-c01', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 {t:'The three routes covered so far differ only in how drug enters. An intravenous bolus puts the entire dose in at once, so input is instantaneous. An intravenous infusion delivers a fixed amount per unit time, so input is zero order. An oral dose delivers at a rate proportional to what is still in the gastrointestinal tract, so input is first order, and it is described by its own rate constant ka. Elimination is first order in all three, so the oral case is the only one with first order on both sides.'},
  ...
  {h:'Where to read more', t:'Shargel & Yu 8e, chapter 16 (Pharmacokinetics of Drug Absorption) and chapter 4 (Physiologic Factors Related to Drug Absorption).'}],
...
{id:'m5-c07', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 {t:'F is the oral bioavailability factor, the proportion of an administered dose that reaches the systemic circulation. It appears only as a multiplier of the dose, so its effect is identical to giving a smaller dose completely: the peak and the area under the curve scale with it, while the timing of the peak does not. The presence of a capital F in an equation is itself the signal that the route is oral.'},
  ...
  {h:'Where to read more', t:'Shargel & Yu 8e, chapter 16 (Pharmacokinetics of Drug Absorption) and chapter 4 (Physiologic Factors Related to Drug Absorption).'},
  {h:'What the chapter adds', t:'Chapter 16 attaches a condition to reading the tail of an oral curve. For an immediate-release product the absorption rate constant exceeds the elimination rate constant, absorption finishes first, and the terminal slope is elimination. For an extended-release product designed so that dissolution is the slow step, absorption is slower than elimination and the terminal slope represents absorption instead. That reversal is called flip-flop, and the way to tell is to compare the terminal slope after an oral dose with the slope after an intravenous dose of the same drug: the two match only when there is no flip-flop.'}],
...
{id:'m5-c22', multi:true, prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 teach:[
  ...
  {h:'What each constant does to the curve', fig:'ka_k_effects', t:'k\u2090 governs only the going-in leg. Raising it fills the body faster, so the peak arrives sooner and higher, and the total exposure is untouched, because AUC = F \u00d7 D/Cl and Cl = k \u00d7 V\u1d05 carries no k\u2090 in it. k governs the going-out leg and sets the clearance with it. Raising k empties the body faster, so the peak is both earlier and lower, and the AUC falls. Either constant moves the timing of the peak, since t\u2098\u2090\u2093 = ln(k\u2090/k)/(k\u2090 \u2212 k) contains both; only k moves the area.'},
  {h:'How the variables relate', list:[
    'rate = rate constant \u00d7 amount: mg/hr = hr\u207b\u00b9 \u00d7 mg.',
    ...
    'tmax = ln(ka/k)/(ka - k) contains both constants and no dose.',
    'AUC = F x D/Cl, so only F, the dose or clearance moves it.']},
  {h:'What the chapter adds', t:'Chapter 16 names the reversed case behind her two descriptions. Where k\u2090 is the larger, the usual disposition-rate-limited case, the terminal phase of the curve is elimination. Where a formulation is built to release slowly, absorption becomes the slower process and the terminal phase reports absorption instead, so a slowly released product can look like a drug with a long half-life when it is not.'}],
 teachImg:'slide_5Pharmacokineticso_p18',
 note:'The handwritten block on this slide lists a third bullet reading that the rate constant increases. It is covered in the image shown here, because the dose changes the rates and not the constants, which is what this item turns on. The other two bullets, that the peak time did not change and that the area rises in proportion to the dose, are both correct and are left in place.', cite:'5---Pharmacokinetics-of-Oral-Absorption.pdf, slide "Changing Dose"; 09.21 lecture',
...
{id:'m5-c23', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 {t:'Increasing ka with k held constant changes how fast the drug gets in but not how much gets in or how fast it is removed. The peak is therefore higher and earlier while the area under the curve is relatively unchanged, since area depends on the amount absorbed and on clearance. This is the pattern that separates two formulations of the same drug in a bioequivalence comparison.'},
  ...
  {h:'Where to read more', t:'Shargel & Yu 8e, chapter 16 (Pharmacokinetics of Drug Absorption) and chapter 4 (Physiologic Factors Related to Drug Absorption).'},
  {h:'What the chapter adds', t:'Chapter 16 names the reversed case that sits behind her two descriptions. Where the absorption rate constant is the larger, the usual disposition-rate-limited case, the terminal phase is elimination. Where a formulation is built to release slowly, absorption becomes the slower process and the terminal phase reports absorption rather than elimination, so a slowly released product can look like a drug with a long half-life when it is not.'}],
