...
{id:'m5-c06', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 options:[
  {t:'Zero-order input with first-order output', correct:true,
   why:'A constant release rate is a fixed amount per hour, which is zero order. Elimination does not depend on the product, so it stays first order. The result looks like an IV infusion: the level climbs and levels off rather than peaking.'},
  {t:'First-order input with first-order output',
   why:'This is the ordinary tablet, and choosing it misses what the product was built to change. Its release slows as less drug is left in it, which is what first order means. A constant-rate product is built so that release does not slow, which makes its input zero order.'},
  {t:'Zero-order input with zero-order output',
   why:'The input half is right and the output half is not. The product controls only release. Once drug is in the plasma the body removes a fixed fraction of it each hour, which is first order, whatever the tablet did.'},
  {t:'Instantaneous input with first-order output',
   why:'Instantaneous input is an IV bolus, where the whole dose enters at once. A product that releases drug steadily over hours is the opposite: its input is spread over time at a constant rate.'}],
 teach:[
  {t:'Each option pairs an input, how drug gets into the plasma, with an output, how it leaves. Decide the two halves separately.'},
  {h:'The output is first order, whatever the product', list:['In this module elimination is first order: each hour the body removes a fixed fraction of the drug in it.', 'A formulation controls only how the drug is released. It cannot change how the body removes drug that is already in the plasma.', 'So every option with a zero-order output is out.']},
  {h:'The input is set by how the drug is released', table:{head:['How drug enters', 'Input', 'Example', 'Curve'], rows:[['All at once', 'Instantaneous', 'IV bolus', 'Highest at time zero, then falls'], ['A fixed fraction of what is left, each hour', 'First order', 'Ordinary tablet or capsule', 'Rises to a peak, then falls'], ['A fixed amount each hour', 'Zero order', 'IV infusion; constant-rate release product', 'Levels off while release continues, then falls']]}, fig:'input_types', after:'The product in the question releases drug at a constant rate: the same amount each hour, however much is left in the tablet. That is a zero-order input. Elimination stays first order, so the product behaves like an IV infusion: the level climbs and levels off rather than rising to a sharp peak.'}],
...
{id:'m5-c07', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 teach:[
  ...
  {h:'How the variables relate', list:['The equation: Cp = {{frac:F ka D0|VD(ka - k)}} (e^(-kt) - e^(-ka t)).', 'The fraction in front is not C0. At time zero the bracket is e^0 - e^0 = 0, so an oral curve starts at zero concentration and has to rise. In her words, “this big portion right here does not represent C0.”', 'To find Cmax, work out tmax first and put it into the whole equation.', 'ka is the absorption rate constant and k is the elimination rate constant. Both are in reciprocal time (hr^-1).', 'Put every time in hours before substituting: a 45-minute half-life is 0.75 hr.', 'The equation takes rate constants, not half-lives, so turn each half-life into its constant first: k = {{frac:0.693|t1/2}} and ka = {{frac:0.693|t1/2a}}.', 'A half-life written with no subscript, plain t1/2 or “the half-life”, means the elimination half-life. The absorption half-life is always labelled: t1/2a, or “the half-life of absorption”.']},
...
{id:'m5-c13', type:'match', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 audit:'The printed slide labels only the absorption phase and the post-absorption phase on the figure. In the 09.21 lecture she found this slide missing from her own copy and taught it from the students\' copies, so her spoken treatment is the only full treatment of the four descriptions used here; the complete elimination phase and the equality of rates at the peak come from the captions rather than from printed slide text.'},
...
{id:'m5-c22', multi:true, prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 options:[
  ...
  {t:'An increase in the rates of absorption and elimination', correct:true,
   why:'A rate is an amount per time, mg/hr. Both legs are first order, so the rate in is k\u2090 times the amount still to be absorbed and the rate out is k times the amount in the body. Doubling the dose doubles both amounts, so both rates double while k\u2090 and k stay where they were. More milligrams per hour are absorbed and more are eliminated, by the same factor on each side, which is why the peak does not move.'},
  {t:'An increase in the rate constants ka and k for absorption and elimination', correct:false,
   why:'A rate constant is a fraction per time, hr\u207b\u00b9, and there are no milligrams in those units, so no quantity of drug can change it. What rises is the rate, mg/hr, which is the constant multiplied by the amount present. k\u2090 answers to the formulation and k to clearance and volume of distribution, since k = Cl/V\u1d05; neither answers to the dose. Reading the rising rate as a rising constant is the error that makes this option attractive.'},
 ...
 teach:[
  {h:'A rate and a rate constant are different quantities', t:'Read their units and they cannot be confused. A rate is an amount per time, mg/hr: how many milligrams actually left this hour. A rate constant is a fraction per time, hr⁻¹: what share of whatever is present leaves each hour. The two are tied by rate = constant × amount, and the units check out, because hr⁻¹ × mg = mg/hr. A constant whose units contain no milligrams cannot be changed by giving more milligrams.'},
  {h:'What doubling the dose does to each', fig:'rate_vs_constant', t:'Doubling the dose doubles the amount, so rate = k × amount doubles with it. The constant is the ratio rate ÷ amount, and doubling both leaves that ratio exactly where it was. The figure marks three moments on two doses of one drug: 200 mg losing 40 mg/hr, 100 mg losing 20 mg/hr, and the 200 mg dose once it has fallen to 100 mg, losing 20 mg/hr again. The rate tracks the amount present; k is 0.2 per hour at every one of them.'},
  {h:'Absorption and elimination are not affected differently here', t:'Both legs are first order, so each has the same form. The rate in is kₐ × the amount still at the absorption site, and the rate out is k × the amount in the body. Doubling the dose doubles both of those amounts, so both rates double by the same factor and neither constant moves. That is exactly why the peak does not shift: the peak is the moment the two rates become equal, and multiplying both by two leaves the moment they cross where it was.'},
  {h:'What would actually move a rate constant', t:'kₐ is a property of the formulation and the absorption conditions, so a different tablet, a different salt or a modified-release design moves it. k is a property of the patient and the drug, and since k = Cl/Vᴅ, anything that changes clearance or the volume of distribution moves it: renal or hepatic impairment, or a change in body size. The dose is not on either list.'},
  {h:'Dose, ka and k: what each one changes', table:{head:['', 'Dose raised', 'ka raised, k the same', 'k raised, ka the same'], rows:[['Cmax', 'Higher, in proportion to the dose', 'Higher: drug arrives faster than it can leave', 'Lower: drug leaves faster while it is still arriving'], ['tmax', 'Unchanged: both rates rise by the same factor', 'Earlier: the rate in meets the rate out sooner', 'Earlier: the rate out catches up with the rate in sooner'], ['AUC', 'Higher, in proportion: twice the milligrams, each staying just as long', 'Unchanged: the same milligrams get in and each stays just as long; only their arrival is earlier', 'Lower: the same milligrams get in, but each is removed sooner and adds to the area for less time'], ['What changed', 'The amount of drug; neither constant', 'The input side', 'The output side']]}, after:'tmax moves earlier whether ka or k is raised, so tmax on its own cannot tell you which one changed. Cmax and AUC can: Cmax goes up with ka and down with k, and only k moves the AUC. AUC depends on how many milligrams get in and how long each one stays: the dose changes the first, k changes the second, and ka changes neither.'},
 ...
 teachImg:'slide_5Pharmacokineticso_p18',
 audit:'The handwritten block on this slide lists a third bullet reading that the rate constant increases. It is covered in the image shown here, because the dose changes the rates and not the constants, which is what this item turns on. The other two bullets, that the peak time did not change and that the area rises in proportion to the dose, are both correct and are left in place.', cite:'5---Pharmacokinetics-of-Oral-Absorption.pdf, slide "Changing Dose"; 09.21 lecture',
...
{id:'m5-c23', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 options:[
  ...
  {t:'Cmax higher, tmax later, AUC increased',
   why:'The height is right but the timing is reversed and the area should not move. Faster input brings the rate in level with the rate out sooner, so the peak is earlier. The AUC depends on the dose, F and clearance, and ka is in none of them.'},
  {t:'Cmax unchanged, tmax earlier, AUC substantially increased',
   why:'The error is moving the peak earlier without letting it rise. Faster input leaves less time for elimination before the rates meet, so the peak is higher. And the AUC cannot rise, because ka does not change clearance.'},
  {t:'Cmax lower, tmax earlier, AUC decreased',
   why:'This mixes up the two cases: it is the answer for raising k, not ka. A lower peak and a smaller AUC come from faster removal; faster input raises the peak instead and leaves the AUC where it was.'}],
 teach:[
  {t:'Raising ka changes only how fast drug gets into the body, not how much gets in or how fast it leaves. Each of the three results follows from the definitions below.'},
  {h:'Two definitions to hold first', list:['tmax answers when; AUC answers how much. They are separate questions, so a change can move one and leave the other.', 'tmax is the moment the rate of drug coming in equals the rate going out. Before it, more arrives than leaves and the level rises; after it, more leaves than arrives and the level falls.', 'AUC is the total exposure the absorbed dose produces before it is removed. Each milligram adds to the area for as long as it stays in the plasma, so AUC is set by two things: how many milligrams get in (the dose and F) and how long each one stays (k). As an equation, AUC = {{frac:F x D0|Cl}} with Cl = k x VD.']},
  {h:'Raising ka, one result at a time', list:['Cmax is higher. Drug arrives faster than elimination can remove it, so the concentration builds higher before the two rates meet.', 'tmax is earlier. The rate in is ka × the amount still waiting to be absorbed. With a larger ka that amount is used up faster, so the rate in falls to meet the rate out sooner.', 'AUC is unchanged. The same milligrams get in, and once in, each is removed at the same k, so each stays in the plasma just as long. ka changes only when they arrive: the curve is taller early and lower later, and those two areas are equal.']},
  {h:'Raising ka against raising k', table:{head:['', 'ka raised, k the same', 'k raised, ka the same'], rows:[['Cmax', 'Higher: drug arrives faster than it can leave', 'Lower: drug leaves faster while it is still arriving'], ['tmax', 'Earlier: the rate in meets the rate out sooner', 'Earlier: the rate out catches up with the rate in sooner'], ['AUC', 'Unchanged: the same milligrams get in and each stays just as long; only their arrival is earlier', 'Lower: the same milligrams get in, but each is removed sooner and adds to the area for less time'], ['What changed', 'The input side', 'The output side']]}, fig:'k_vs_ka', after:'The figure uses the values on her slide: a 100 mg dose, a volume of distribution of 10 L, and the constant that is not being changed held at 0.1 hr^-1. The shaded areas are the difference in AUC. Raising k from 0.2 to 0.5 hr^-1 loses area at every time, and the AUC falls from 50 to 20 µg·hr/mL. Raising ka from 0.2 to 0.5 hr^-1 gains 14.3 µg·hr/mL before the curves cross at 9.4 hours and loses the same 14.3 afterwards, so the AUC stays at 100. tmax moves earlier in both, so tmax on its own cannot tell you which constant changed; Cmax and AUC can.'}],
...
{id:'m5-c24', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 options:[
  ...
  {t:'Cmax lower, tmax later, AUC decreased',
   why:'The Cmax and AUC are right; the timing is reversed. The peak is the moment the rate out equals the rate in, and faster removal reaches that moment sooner, so the peak comes earlier, not later.'},
  {t:'Cmax lower, tmax earlier, AUC unchanged',
   why:'The error is carrying the AUC result for a change in ka across to k. AUC stays the same only when clearance does, and raising k raises clearance (Cl = k x VD), so AUC falls.'},
  {t:'Cmax higher, tmax earlier, AUC unchanged',
   why:'This mixes up the two cases: it is the answer for raising ka, not k. Faster removal cannot leave more drug in the plasma, so the peak cannot rise, and the higher clearance lowers the AUC.'}],
 teach:[
  {t:'Raising k changes only how fast drug leaves the body. Each of the three results follows from the definitions below.'},
  {h:'Two definitions to hold first', list:['tmax answers when; AUC answers how much. They are separate questions, so a change can move one and leave the other.', 'tmax is the moment the rate of drug coming in equals the rate going out. Before it, more arrives than leaves and the level rises; after it, more leaves than arrives and the level falls.', 'AUC is the total exposure the absorbed dose produces before it is removed. Each milligram adds to the area for as long as it stays in the plasma, so AUC is set by two things: how many milligrams get in (the dose and F) and how long each one stays (k). As an equation, AUC = {{frac:F x D0|Cl}} with Cl = k x VD.']},
  {h:'Raising k, one result at a time', list:['Cmax is lower. Drug is being removed faster while it is still arriving, so the concentration cannot build as high.', 'tmax is earlier. The rate out is k × the amount in the body. With a larger k, the rate out catches up with the rate in while less drug has built up, and that happens sooner.', 'AUC is lower. The same milligrams get in, but each is removed sooner, so it spends less time in the plasma adding to the area. That is the same thing as saying clearance has risen, since Cl = k x VD.']},
  {h:'Raising k against raising ka', table:{head:['', 'k raised, ka the same', 'ka raised, k the same'], rows:[['Cmax', 'Lower: drug leaves faster while it is still arriving', 'Higher: drug arrives faster than it can leave'], ['tmax', 'Earlier: the rate out catches up with the rate in sooner', 'Earlier: the rate in meets the rate out sooner'], ['AUC', 'Lower: the same milligrams get in, but each is removed sooner and adds to the area for less time', 'Unchanged: the same milligrams get in and each stays just as long; only their arrival is earlier'], ['What changed', 'The output side', 'The input side']]}, fig:'k_vs_ka', after:'The figure uses the values on her slide: a 100 mg dose, a volume of distribution of 10 L, and the constant that is not being changed held at 0.1 hr^-1. The shaded areas are the difference in AUC. Raising k from 0.2 to 0.5 hr^-1 loses area at every time, and the AUC falls from 50 to 20 µg·hr/mL. Raising ka from 0.2 to 0.5 hr^-1 gains 14.3 µg·hr/mL before the curves cross at 9.4 hours and loses the same 14.3 afterwards, so the AUC stays at 100. tmax moves earlier in both, so tmax on its own cannot tell you which constant changed; Cmax and AUC can.'}],
 teachImg:'slide_5Pharmacokineticso_p19',
 cite:'5---Pharmacokinetics-of-Oral-Absorption.pdf, slide "Effect of ka and k on Cmax, tmax, and AUC"; 09.21 lecture',
...
{id:'m5-c25', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 teach:[
  ...
  {h:'Dose, ka and k: what each one changes', table:{head:['', 'Dose raised', 'ka raised, k the same', 'k raised, ka the same'], rows:[['Cmax', 'Higher, in proportion to the dose', 'Higher: drug arrives faster than it can leave', 'Lower: drug leaves faster while it is still arriving'], ['tmax', 'Unchanged: both rates rise by the same factor', 'Earlier: the rate in meets the rate out sooner', 'Earlier: the rate out catches up with the rate in sooner'], ['AUC', 'Higher, in proportion: twice the milligrams, each staying just as long', 'Unchanged: the same milligrams get in and each stays just as long; only their arrival is earlier', 'Lower: the same milligrams get in, but each is removed sooner and adds to the area for less time'], ['What changed', 'The amount of drug; neither constant', 'The input side', 'The output side']]}, after:'tmax moves earlier whether ka or k is raised, so tmax on its own cannot tell you which one changed. Cmax and AUC can: Cmax goes up with ka and down with k, and only k moves the AUC. AUC depends on how many milligrams get in and how long each one stays: the dose changes the first, k changes the second, and ka changes neither.'},
  {h:'How the variables relate', list:['AUC = {{frac:F x D0|Cl}} and Cl = k x VD. ka appears in neither, which is why a change in ka leaves AUC where it was.', 'tmax = {{frac:ln(ka/k)|ka - k}}: both constants and no dose, which is why a change in dose leaves tmax where it was.', 'Disposition rate limited is the usual case, with ka much larger than k; the reverse is absorption rate limited.']},
  {h:'What the chapter adds: immediate against extended release', t:'This is about the tail of an oral curve: the last part, after the peak, where the curve becomes a straight line on a log scale. The slope of that straight part is set by whichever of the two rate constants is smaller, because by then the faster process has finished. Chapter 16 uses this to tell two kinds of product apart.', table:{head:['', 'Immediate release', 'Extended release, built to dissolve slowly'], rows:[['Larger constant', 'ka is larger than k', 'ka can be smaller than k'], ['Still happening in the tail', 'Elimination only; absorption has finished', 'Absorption, which is now the slower step'], ['Slope of the tail gives', 'k', 'ka, a reversal called flip-flop'], ['Against an IV dose of the same drug', 'Oral tail runs parallel to the IV line', 'Oral tail is flatter than the IV line']]}, fig:'flipflop', after:'The figure shows one drug given as both products, so k is the same for both curves. The immediate-release tail is steep because absorption has finished and only elimination is left. The extended-release tail is shallow because absorption is still going on and is the slower step. An oral curve on its own cannot say which case it is. The chapter’s test is to give the same drug intravenously, because an IV curve falls with k: a tail parallel to the IV line is falling with k, and a flatter one is falling with ka. In the flip-flop case a slowly released product can look as if the drug has a long elimination half-life when the slow step is really its absorption.'}],
...
{id:'m5-n10', type:'numeric', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 audit:'The four-hour time point is not one she asks for. The equation, both rate constants and the coefficient are hers as printed on the slide; only the substitution time is chosen here, to give a question on the deck objective of calculating the plasma concentration at any time after an oral dose.'},
...
{id:'m5-n11', type:'numeric', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 audit:'The captions record the instruction as dividing 1.5 by 0.693, with the operands reversed; her own arithmetic in the same passage is 0.693 divided by 1.5, which gives the 0.462 per hour she then uses. The keyed answer follows her arithmetic.'},
...
{id:'m5-n13', type:'numeric', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 note:'The printed practice sheet gives the volume of distribution as 40 L. In class she changed it to 20 L before working the problem, and this question uses 20 L. With 40 L the peak is half as high, 6.57 mg/L, which is the next question.',
 audit:'The printed practice sheet gives the apparent volume of distribution as 40 L. In the 09.21 lecture she changed it aloud to 20 L before working the problem and every figure she then quotes uses 20 L, so 20 L is used here. With the printed 40 L the same working gives 6.57 mg/L.'},
...
{id:'m5-n14', type:'numeric', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 note:'This is the printed practice sheet’s version, with a volume of distribution of 40 L. In class she used 20 L, which gives 13.13 mg/L.',
 audit:'The printed practice sheet gives 40 L and she replaced it with 20 L in class, so the printed value is keyed here and m5-n13 keys the value she worked with. No answer for the 40 L version is spoken in the lecture; the 6.57 mg/L here is her own working repeated with the printed volume.'},
...
{id:'m5-n19', type:'numeric', prof:'Mosley', tier:'new', exam:2, module:5, lecture:'L06',
 ...
 quote:'we increase the dose, we expect a proportional increase in concentration and AUC. We do not expect a change in TMAX',
 audit:'The 500 mg dose, the parameters and the 12.17 mg/L peak are hers from Example 1; the doubling is the change described on her Changing Dose slide applied to that example. She does not work a doubled version of Example 1 aloud.'},
