...
{id:'m2-vd-4', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L02',
 ...
 options:[
  ...
  {t:'14 kg', correct:false,
   why:'The arithmetic is right and the unit is wrong. A volume of distribution must be reported in units of volume; the kilogram only enters as the bridge that lets a percentage of body weight be converted into litres.'},
...
{id:'m2-n-deck12', type:'numeric', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L02',
 ...
 audit:'She reports the half-life of this drug as 8.15 hr in class, which follows from k rounded to 0.085 hr⁻¹. Carrying k unrounded at 0.085138 hr⁻¹ gives 8.14 hr. The 12-hour amount is 72 mg either way, so the amount is keyed here rather than the half-life.'},
...
{id:'m2-mc-2', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L03',
 ...
 audit:'The deck slide "Why Multicompartment Models?" plots log Cp against time without labelling the scale as logarithmic. Dr. Mosley supplies the reading rule out loud and repeats it in the exam review, so the rule is taken from the transcript. An exam written from these lectures would expect the scale to be inferred from the axis values.'},
...
{id:'m2-mc-7', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L03',
 ...
 audit:'The slide presents the method as a procedure to be carried out. Dr. Mosley says in the 26 August lecture that she wants the concept known but will not ask students to perform it, and that she will supply A, B, alpha and beta instead. The definition alone is what is examinable here; an exam written from these lectures would not ask for a feathered fit.'},
...
{id:'m2-n-k21', type:'numeric', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L03',
 ...
 audit:'As with the overall k for this sheet, the parameter values are handwritten on this copy of the deck and are used only because every answer she reads aloud on 26 August reproduces from them exactly. She reports k21 to one decimal place as 0.9 per hour.'},
...
/* ---------- L02 numeric: the rest of her a–h battery from two plasma points.
   ...
   exactly as IV-Bolus-Practice-2---Solutions.pdf works them. ---------- */
{id:'m2-n-t2', type:'numeric', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L02',
 topic:'bolus1', sub:'calc', concept:'t-half-from-k', skill:'krate',
 source:'slide', dupOf:'m2-n-t1',
 stem:'An antibiotic given as a 250 mg IV bolus injection has an elimination rate constant of 0.2769 hr⁻¹. What is its half-life of elimination?',
 units:'hr',
 answer:2.5,
 tol:0.08,
 steps:[
  {k:'setup', t:'t½ = 0.693 / k',
   why:'Half-life is the time for the concentration to fall by half, and for a first-order process that time is fixed by the rate constant alone. The 0.693 is the natural logarithm of 2, which is what falls out of solving Ct = C0e^(−kt) for Ct equal to half of C0.'},
  {k:'algebra', t:'t½ = 0.693 / (0.2769 hr⁻¹) = 2.5027 hr',
...
{id:'m2-n-c0b', type:'numeric', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L02',
 topic:'bolus1', sub:'calc', concept:'c0-back-extrapolation', skill:'conctime',
 source:'slide', dupOf:'m2-n-c0a',
 stem:'An antibiotic given as a 250 mg IV bolus injection has an elimination rate constant of 0.2769 hr⁻¹ and a plasma concentration of 2.18 mcg/mL at 8 hours. What is the initial plasma concentration?',
 units:'mg/L',
 answer:20,
 tol:0.5,
 steps:[
  {k:'setup', t:'C0 = Ct·e^(+kt), with t the time of the measured sample',
   why:'No sample can be drawn at the instant of the injection, so the initial concentration has to be recovered from a later one. Running the decay backwards makes the exponent positive, which is the one sign change the step turns on.'},
  {k:'unit', t:'2.18 mcg/mL = 2.18 mg/L',
   why:'A microgram per millilitre and a milligram per litre are the same number, so nothing has to be converted. The switch of label matters here because the volume of distribution in the next part pairs this concentration with a dose in milligrams, and litres is what makes that division come out in litres.'},
  {k:'algebra', t:'C0 = (2.18 mg/L)e^((0.2769 hr⁻¹)(8 hr)) = (2.18 mg/L)(9.1632) = 19.98 mg/L',
...
{id:'m2-n-c15b', type:'numeric', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L02',
 topic:'bolus1', sub:'calc', concept:'cp-at-time', skill:'conctime',
 source:'slide', dupOf:'m2-n-c15',
 stem:'An antibiotic given as a 250 mg IV bolus injection has an initial plasma concentration of 20 mg/L and an elimination rate constant of 0.2769 hr⁻¹. What is the concentration of drug in the plasma 15 minutes after the dose was given?',
 units:'mg/L',
 answer:18.66,
 tol:0.3,
 steps:[
  {k:'setup', t:'Ct = C0·e^(−kt)',
   why:'The concentration at any time after a bolus is the intercept decayed for the elapsed time, and the whole of the dose is in the body at time zero. Nothing else is needed once C0 and k are in hand.'},
  {k:'unit', t:'15 minutes = 15/60 hr = 0.25 hr',
   why:'The rate constant is in reciprocal hours, so the time has to be in hours for the exponent to come out dimensionless. She gives the interval in minutes every time this part appears and converts it silently, which is where the mark is usually lost.'},
  {k:'algebra', t:'Ct = (20 mg/L)e^(−(0.2769 hr⁻¹)(0.25 hr)) = (20 mg/L)(0.93312) = 18.66 mg/L',
...
{id:'m2-n-vd2', type:'numeric', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L02',
 topic:'bolus1', sub:'calc', concept:'vd-from-dose-c0', skill:'vddose',
 source:'slide', dupOf:'m2-n-vd1',
 stem:'A 250 mg intravenous bolus dose of an antibiotic produces an initial plasma concentration of 20 mg/L in a 70-kg patient. What is the apparent volume of distribution?',
 units:'L',
 answer:12.5,
 tol:0.3,
 steps:[
  ...
  {k:'algebra', t:'VD = (250 mg) / (20 mg/L) = 12.5 L',
...
{id:'m2-n-cl3', type:'numeric', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L02',
 topic:'bolus1', sub:'calc', concept:'cl-from-k-vd', skill:'clearance',
 source:'slide', dupOf:'m2-n-cl1',
 stem:'An antibiotic has an apparent volume of distribution of 12.5 L and an elimination rate constant of 0.2769 hr⁻¹ in a patient. What is the total body clearance of this drug in this patient?',
 units:'L/hr',
 answer:3.46,
 tol:0.1,
 steps:[
  {k:'setup', t:'Cl = k · VD',
   why:'Clearance is the volume of plasma cleared of drug per unit time, and it is the fraction removed per hour multiplied by the volume that fraction is taken from. Both quantities are already in hand from the earlier parts, so no new data are needed.'},
  {k:'algebra', t:'Cl = (0.2769 hr⁻¹)(12.5 L) = 3.4613 L/hr',
...
{id:'m2-n-d3b', type:'numeric', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L02',
 topic:'bolus1', sub:'calc', concept:'amount-at-time', skill:'conctime',
 source:'slide', dupOf:'m2-n-d3a',
 stem:'An antibiotic was given as a 250 mg IV bolus injection and has an elimination rate constant of 0.2769 hr⁻¹. What is the amount of drug in the body 3 hours after the drug was administered?',
 units:'mg',
 answer:108.9,
 tol:2.0,
 steps:[
  {k:'setup', t:'Dt = D0·e^(−kt)',
   why:'Amounts decay by the same first-order law as concentrations, with the same rate constant, because the two differ only by the fixed volume of distribution. Working in amounts here avoids computing a concentration and multiplying it back by 12.5 L.'},
  {k:'algebra', t:'Dt = (250 mg)e^(−(0.2769 hr⁻¹)(3 hr)) = (250 mg)(0.43574) = 108.9 mg',
...
{id:'m2-n-999b', type:'numeric', prof:'Mosley', tier:'new', exam:1, module:2, lecture:'L02',
 topic:'bolus1', sub:'calc', concept:'time-for-999-percent', skill:'krate',
 source:'slide', dupOf:'m2-n-999a',
 stem:'An antibiotic given by intravenous bolus injection has an elimination half-life of 2.5 hours. How much time is required for 99.9% of the drug to be eliminated from the body?',
 units:'hr',
 answer:25,
 tol:0.8,
 steps:[
  ...
  {k:'algebra', t:'By the equation: t = ln(100/0.1) / (0.2769 hr⁻¹) = 6.9078 / 0.2769 hr⁻¹ = 24.95 hr',
