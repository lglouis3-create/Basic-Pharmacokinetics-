...
{id:'db-tau', module:6, name:'Amount left after one dosing interval', sheet:'unknown',
 ...
 symbols:[['D<sub>B</sub>', 'amount of drug in the body one interval after a dose, mg'], ['D<sub>0</sub>', 'the dose, mg'],
          ['&tau;', 'the dosing interval, hr: the time between doses']],
 holds:'A single IV bolus, first-order elimination. DB/D0 = e^-k&tau; is the fraction of the dose still in the body when the next dose is due.',
...
{id:'dmax-ss', module:6, name:'Maximum amount at steady state', sheet:'yes',
 ...
 lures:['D<sub>0</sub>e<sup>&minus;k&tau;</sup>', '(1 + e<sup>&minus;k&tau;</sup>)', '&times;'],
 symbols:[['D<sub>0</sub>', 'the dose given at each interval, mg'], ['&tau;', 'dosing interval, hr'], ['&infin;', 'at steady state']],
 holds:'Repeated IV bolus at a fixed dose and interval, first-order elimination, at steady state. 1/(1 &minus; e^-k&tau;) is the drug accumulated.',
...
{id:'dmin-ss', module:6, name:'Minimum amount at steady state', sheet:'yes',
 ...
 lures:['D<sub>0</sub>', '(1 + e<sup>&minus;k&tau;</sup>)', 'e<sup>&minus;kt</sup>'],
 symbols:[['D<sub>0</sub>', 'dose, mg'], ['&tau;', 'dosing interval, hr']],
 holds:'As for the maximum. The minimum comes at the end of the dosing interval, so it is the maximum multiplied by e^-k&tau;.',
 cite:'6---Repetitive-IV-Bolus-and-Intermittent-IV-Infusions.pdf, slide "Amount of Drug in the Body at Steady-State Following Repeated IV Bolus Injections"'},
...
{id:'davg-ss', module:6, name:'Average amount at steady state', sheet:'yes',
 ...
 lures:['V<sub>D</sub>', '2', '(1 &minus; e<sup>&minus;k&tau;</sup>)'],
 symbols:[['F', 'bioavailability; 1 for an IV dose'], ['k', 'hr&minus;1'], ['&tau;', 'dosing interval, hr']],
 holds:'Steady state. Not the average of the maximum and minimum amounts, because the decline between doses is exponential.',
 cite:'6---Repetitive-IV-Bolus-and-Intermittent-IV-Infusions.pdf, slide "Amount of Drug in the Body at Steady-State Following Repeated IV Bolus Injections"'},
...
{id:'cmax-ss', module:6, name:'Maximum concentration at steady state', sheet:'yes',
 ...
 lures:['C<sub>0</sub>e<sup>&minus;k&tau;</sup>', '(1 + e<sup>&minus;k&tau;</sup>)', '&times;'],
 symbols:[['C<sub>0</sub>', 'the first-dose peak, D<sub>0</sub>/V<sub>D</sub>, mg/L'], ['&tau;', 'dosing interval, hr'], ['&infin;', 'at steady state']],
 holds:'Repeated IV bolus at steady state. The first-dose peak divided by (1 &minus; e^-k&tau;), so it is always higher than C0.',
...
{id:'cmin-ss', module:6, name:'Minimum concentration at steady state', sheet:'yes',
 ...
 lures:['C<sub>0</sub>', '(1 + e<sup>&minus;k&tau;</sup>)', 'e<sup>&minus;kt</sup>'],
 symbols:[['C<sub>0</sub>', 'D<sub>0</sub>/V<sub>D</sub>, mg/L'], ['&tau;', 'dosing interval, hr']],
 holds:'Steady state, at the end of the interval. Equal to the steady-state maximum multiplied by e^-k&tau;, one interval of first-order decline.',
 cite:'6---Repetitive-IV-Bolus-and-Intermittent-IV-Infusions.pdf, slide "Concentration of Drug in the Body at Steady-State Following Repeated IV Bolus Injections"'},
...
{id:'cavg-ss', module:6, name:'Average concentration at steady state', sheet:'yes',
 ...
 lures:['k&tau;', '2', '(1 &minus; e<sup>&minus;k&tau;</sup>)'],
 symbols:[['F', 'bioavailability; 1 for an IV dose'], ['Cl<sub>T</sub>', 'total body clearance, V<sub>D</sub>k, L/hr'], ['&tau;', 'dosing interval, hr']],
...
{id:'cav-auc', module:6, name:'Average concentration from the area over one interval', sheet:'unknown',
 ...
 lures:['AUC<sub>0</sub><sup>&infin;</sup>', 'k', '&times;'],
 symbols:[['[AUC]<sub>t1</sub><sup>t2</sup>', 'area under the curve over one dosing interval at steady state'], ['&tau;', 't2 &minus; t1, hr']],
 holds:'Steady state, one dosing interval. The area over the interval divided by its length.',
...
{id:'cp-n', module:6, name:'Concentration at any time after n doses', sheet:'yes',
 ...
 also:['Cp = D0/VD*(1-e^(-nkτ))/(1-e^(-kτ))*e^(-kt)'],
 lures:['(1 &minus; e<sup>&minus;nkt</sup>)', 'e<sup>&minus;k&tau;</sup>', '(1 + e<sup>&minus;k&tau;</sup>)'],
 symbols:[['n', 'the dose number just given'], ['t', 'time since that dose, hr'], ['&tau;', 'dosing interval, hr']],
...
{id:'cp-ss', module:6, name:'Concentration at any time at steady state', sheet:'unknown',
 ...
 also:['Cp = D0/VD*1/(1-e^(-kτ))*e^(-kt)'],
 lures:['(1 &minus; e<sup>&minus;nk&tau;</sup>)', 'e<sup>&minus;k&tau;</sup>', 'C<sub>min</sub><sup>&infin;</sup>'],
 symbols:[['t', 'time since the most recent dose, hr'], ['&tau;', 'dosing interval, hr']],
 holds:'Steady state. The first two factors are Cmax at steady state, so this is Cmax&infin; e^-kt, which also gives the level after the last dose.',
